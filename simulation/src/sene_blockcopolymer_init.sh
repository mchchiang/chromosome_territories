...
gen_chromo_exe="../bin/exe/GenBlockCopolymer"

num_of_beads=2000
num_of_type1_beads=1000
init_box_size=100
box_size=20
buffer=6
...
sim_name="sene_N_${num_of_beads}_L_${box_size}_HH_${e_hethet}_HL_${e_hetlam}_run_${run}"
...
cp sene_blockcopolymer.lam $file
...
${gen_chromo_exe} $num_of_beads $num_of_type1_beads $init_box_size $init_box_size $init_box_size $buffer "${run_dir}/${init_file}" "${run_dir}/${map_file}"
