...
if [ "$#" != 4 ]; then
    echo "Usage: senescence.sh [e_hethet] [e_hetlam] [run] [run_dir]"
    exit 1
fi
...
lammps_script="senescence.lam"
#lammps_script="senescence_fbc.lam"

chromo_file="../../data/encode_data/chromo_length.dat"
