// create_chromo.cpp
// A code to generate the input LAMMPS file for the chromatin-lamina
// simulation. The chromosome is initialised as a random walk bead chain.
