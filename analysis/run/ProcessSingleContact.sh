...
nocent_file="${dir}/contact_${name}.dat"
norm_file="${dir}/contact_${name}.dat"
eigen_file="${dir}/eigen_${name}.dat"
corr_file="${dir}/corr_${name}.dat"
localdistal_file="${dir}/local-distal_${name}.dat"
